...
export type ResolversTypes = ResolversObject<{
  ...
  CTokenTransfer: ResolversTypes['TransferEvent'] | ResolversTypes['MintEvent'] | ResolversTypes['RedeemEvent'] | ResolversTypes['LiquidationEvent'];
...
export type ResolversParentTypes = ResolversObject<{
  ...
  CTokenTransfer: ResolversParentTypes['TransferEvent'] | ResolversParentTypes['MintEvent'] | ResolversParentTypes['RedeemEvent'] | ResolversParentTypes['LiquidationEvent'];
  TransferEvent_filter: TransferEvent_filter;
  MintEvent: MintEvent;
  MintEvent_filter: MintEvent_filter;
...
export type MeshContext = Uniswapv2Types.Context & Compoundv2Types.Context & BaseMeshContext;
